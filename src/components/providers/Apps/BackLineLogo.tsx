...
export const BackLineLogo = () => {
  return (
    <div className="hidden lg:block absolute end-40 lg:end-52 2xl:end-72 top-0 h-full z-0">
      ...
      <Image
        ...
        className=""
      />
      <div className="border-e me-1 border-secondary-200 h-[calc(100%-70dvh-80px)] min-h-[calc(100vh-70dvh-80px)]"></div>
    </div>
  );
};
