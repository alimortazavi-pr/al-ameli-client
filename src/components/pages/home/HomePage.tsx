...
export const HomePage = () => {
  return (
    <div className="w-screen h-[100dvh] flex">
      <AsideContainer />
      <div className="w-full lg:w-8/12 2xl:w-9/12 h-full bg-blue-300 bg-[url(./../images/bg-hero.jpg)] bg-center bg-cover relative flex flex-col justify-end items-center lg:items-end lg:pe-[10vh] pb-[10vh]">
